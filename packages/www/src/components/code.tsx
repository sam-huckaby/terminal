...
const Code: Component<CodeProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      >
        {copied() ? (
          <svg viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" class="size-5 text-green-11">
          ...
          <svg viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" class="size-5">
